...
{
	// MOD管理名：システムへの登録時に使用
	public static final String MOD_ENTRY_NAME = "exampleblock";
	...
	// ブロックの爆破耐性
	private static final float BLOCK_RESISTANCE = 1.0f;
	// ブロックを歩いた時の音
	...
	// ブロックの明るさ(15 = 1.0f)
	private static final float BLOCK_BRIGHTLEVEL = 1.0f;
	...
	public ExampleBlock()
	{
		...
		setUnlocalizedName("BlockExample");
